...
(function themes() {
    ...
    var stylesheets = {
        ...
        blackhighlight: document.querySelector("[href$='blackhighlight.css']"),
    ...
    function set_theme(theme, store = true) {
        ...
        if (theme == 'coal' || theme == 'navy') {
            ...
            stylesheets.blackhighlight.disabled = true;
            ...
            stylesheets.tomorrowNight.disabled = false;
            stylesheets.highlight.disabled = true;
            stylesheets.blackhighlight.disabled = false;
...
//             event.preventDefault(); // 阻止默认跳转行为，以实现平滑滚动
